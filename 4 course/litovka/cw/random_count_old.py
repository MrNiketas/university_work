...
def generate_process(L, T, C3):
    ...
    # начальное значение концентрации для всех веществ
    c10 = 0
    c20 = 20
    c30 = C3[0]
    c40 = 0
    ...
    c20 = (c20 * ro) / (100 * 0.03)
    c3p = (c30 * 100 * 0.058) / ro
    c50 = (100 - (c3p + 20)) / (100 * 0.044)

    for taoi in np.arange(0, tao, dtao):
        l0 = 0.0
        c30 = C3[taoi]
